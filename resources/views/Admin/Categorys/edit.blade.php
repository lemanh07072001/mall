@php
    ...
    $getAll = FormatFunction::getCategory($getFind);
@endphp
...
@section('breadcrumb')
    {{ Breadcrumbs::render('editCategory',$getFind) }}
@endsection
...
@section('content')
    <div class="row d-flex justify-content-center">
        <div class="col-lg-6 ">
            <div class="card card-primary">
                ...
                <!-- form start -->
                <form method="POST" action="{{route('category.update',['id'=>$getFind->id])}}">
                    @csrf
                    <div class="card-body">
                        ...
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="parent_id">
                                        ...
                                        @foreach($getAll as $item)
                                            ...
                                            <option value="{{$item->id}}"{{old('parent_id')==$item->id||$getFind->parent_id==$item->id?'selected':''}}> {{str_repeat('/---',$item->depth)}}{{$item->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <button type="button" class="btn btn-success btn-block" data-toggle="modal" data-target="#modalAddCategory">
                        ...
                        <div class="form-check">
                            <input type="checkbox" class="form-check-input" id="exampleCheck1" name="status" {{old('status')=='0'||$getFind->status=='0'?'checked':''}}>
    ...
    @include('Admin.Categorys.modalAddCategory')
@endsection
